...
class PPArrayGet extends PPExpr
{
    ...
    UPPExpr toUPP(ArrayList<String> locals)
    {
        UPPExpr t_new_index = new UPPMul(index.toUPP(locals), new UPPCte(4));

        return new UPPLoad(new UPPAdd(arr.toUPP(locals), t_new_index));
    }// toUPP
...
class PPArraySet extends PPInst
{
    ...
    UPPInst toUPP(ArrayList<String> locals)
    {
        ...
        return new UPPStore(new UPPAdd(arr.toUPP(locals), t_new_index), val.toUPP(locals));
    }// toUPP
...
class PPProcCall extends PPInst
{
    ...
    UPPInst toUPP(ArrayList<String> locals)
    {
        ArrayList<UPPExpr> t_args = new ArrayList<UPPExpr>();
        for (PPExpr t_expr : args)
            t_args.add(t_expr.toUPP(locals));

        return new UPPProcCall(callee, t_args);
    }// toUPP
