breed [ loups loup]
breed [ lapins-mâle lapin-mâle ]
breed [ lapins-femelle lapin-femelle ]

patches-own[odeur-mâle  odeur-femelle]
...
to setup
  ...
  create-lapins-femelle nombre-lapins-femelle [
    set color pink
    setxy random-xcor random-ycor
    set size 5 ;; pour mieux voir les tortues
  ]
...
to go
  ask lapins-mâle [go-lapin-mâle ]
  ask lapins-femelle[go-lapin-femelle]
  ask loups [go-loup]
  diffuse-odeur-lapin-mâle
  diffuse-odeur-lapin-femelle
  evaporation-mâle
  evaporation-femelle
...
to diffuse-odeur-lapin-mâle
  diffuse odeur-mâle (taux-diffusion / 100)
end

to diffuse-odeur-lapin-femelle
  diffuse odeur-femelle (taux-diffusion / 100)
end
...
to go-lapin-femelle
  ...
  fuite
  fd 1
  set odeur-femelle max-odeur
end

to go-loup
 agiter
 suivre-odeur-sans-uphill
 fd 0.8
end
...
to evaporation-mâle
  ask patches [set odeur-mâle odeur-mâle - (odeur-mâle * taux-evaporation / 100 )]
end

to evaporation-femelle
  ask patches [set odeur-femelle odeur-femelle - (odeur-femelle * taux-evaporation / 100 )]
end
...
to suivre-odeur-sans-uphill
  let m max-one-of neighbors [odeur-mâle]
  let f max-one-of neighbors [odeur-femelle]
  ifelse [odeur-mâle] of m > [odeur-femelle] of f
  [
