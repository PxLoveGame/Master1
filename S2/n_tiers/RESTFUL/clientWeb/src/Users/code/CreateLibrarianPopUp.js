...
export default class CreateLibrarianPopUp extends Component {
    ...
    render() {
        ...
        return <span>
            <RaisedButton onClick={this.handleOpen}>Post Librarian</RaisedButton>
              <Dialog
                  title="Création d'un Bibliothecaire"
                  actions={actions}
                  modal={true}
    ...
    postBook = () => {
        ...
        request.post("http://localhost:16223/api/bibliothecaire")
